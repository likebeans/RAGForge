...
async def main():
    ...
    # 如果没有找到知识库，询问是否创建示例数据
    print("\n🤔 如果上面的测试显示没有知识库，是否创建示例数据进行测试？")
    create_sample = input("创建示例数据？(y/n): ").lower().strip() == 'y'
