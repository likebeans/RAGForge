...
批量增强时会输出详细进度日志，便于监控处理状态：

```
[Chunk增强] 开始处理 20 个 chunk，文档: 复方南五加口服液说明书...
[Chunk增强] 进度: 5/20 (成功: 5, 失败: 0)
[Chunk增强] 进度: 10/20 (成功: 10, 失败: 0)
[Chunk增强] 进度: 15/20 (成功: 15, 失败: 0)
[Chunk增强] 进度: 20/20 (成功: 20, 失败: 0)
[Chunk增强] 完成，共 20 个 chunk，成功: 20，失败: 0
```
